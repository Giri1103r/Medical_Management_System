...
const store = async (req, res) => {
    ...
    try {
        ...
        const newMenu = new LeftMenu({ name, namekey:name_key, link, icon, parent_id, module_id, is_parent, sort_order,modkey:mod_key, permission ,status:1 });
...
module.exports = { getMenus, getParentName,store }