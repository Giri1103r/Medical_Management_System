...
import DepartmentAdd from "./admin/master/depart/add";
import Departmentlist from "./admin/master/depart/list";
import DepartmentEdit from "./admin/master/depart/edit";
import DepartmentView from "./admin/master/depart/view";
