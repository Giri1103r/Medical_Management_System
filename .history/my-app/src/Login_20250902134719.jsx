                ...
                <div className="card px-3">
                    <div className="row">
                        ...
                        <div className="col-md-4 mx-auto">
                            <button type='submit' className='btn btn-primary pr-4' disabled={isSubmitting}>Login</button>

                            <button type='button' className='btn btn-primary mr-2' onClick={()=> navigate("/register")}>Register</button>
