          ...
          <FlashProvider>
            <div className="">
              <Routes>
                ...
                <Route path="/department" element={<Delist />} />
                <Route path="/department/add" element={<DeAdd />} />
                <Route path="/department/edit/:id" element={<DeEdit />} />
                <Route path="/department/view/:id" element={<DeView />} />
