                        ...
                        <div className="row">
                            <div className="col-md-12">
                                ...
                                <div className="col-md-4">
                                    ...
                                    <input type="email" name='email' id='email' placeholder="Enter the email" {...register("email",{
                                ...
                                <div className="col-md-4">
                                    ...
                                    <input type="text" name='phone_number' id='phone_number' placeholder="Enter the Phone Number" {...register("phone_number",{
