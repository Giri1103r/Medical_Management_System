  ...
  return (
    <header className="flex items-center justify-between px-4 py-2 shadow-sm bg-white dark:bg-gray-800 fixed top-0 left-0 right-0 z-40">
      ...
      <div className="flex items-center">
        {/* Mobile menu button */}
        <button
          className="lg:hidden p-2 mr-2 border rounded bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600"
        ...
        <a href="/dashboard" className="flex items-center">
          <img src="/images/logo.png" alt="logo" className="mx-2 h-8 w-8 rounded" />
        </a>

        {/* Page title */}
        <h5 className="ml-3 text-lg font-medium text-gray-800 dark:text-gray-200">{title}</h5>
      </div>
