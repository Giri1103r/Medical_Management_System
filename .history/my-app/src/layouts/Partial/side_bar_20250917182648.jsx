...
const SideBar = ({ item, menuData }) => {
  ...
  console.log("Menu Item:", item); // check structure of each item

  // ✅ Use id or _id consistently
...
const SidebarMenu = ({ menuData }) => {
  // ✅ Make sure root is found (string vs number mismatch can also be a problem)
