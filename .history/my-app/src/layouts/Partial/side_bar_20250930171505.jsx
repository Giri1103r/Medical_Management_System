  ...
  return (
    <li>
      ...
      {hasChildren ? (
        ...
        <Link
          to={item.link}
          className="inline-flex items-center w-full px-4 py-2 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500"
        >
          <i className={`${item.icon} w-5 h-5 mr-2`} />
