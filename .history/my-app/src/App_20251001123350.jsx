...
import HospitalAdd from "./admin/master/department/add";
import Hospitallist from "./admin/master/department/list";
import HospitalEdit from "./admin/master/department/edit";
import HospitalView from "./admin/master/department/view";
