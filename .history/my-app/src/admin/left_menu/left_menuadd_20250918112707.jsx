                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                           ...
                           <div>
                            <label htmlFor="parent_id" className='block tect-sm font-medium text-gray-700'>
                                <select name="parent_id" {...register} id="parent_id" className="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"></select>
                            </label>
                           </div>
