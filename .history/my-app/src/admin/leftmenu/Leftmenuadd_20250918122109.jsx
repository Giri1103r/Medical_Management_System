            ...
            <div className="max-w-6xl mx-auto mt-6 px-4">
                <form onSubmit={handleSubmit(onSubmit)}>
                    <div className="bg-white shadow-md rounded-xl p-6">
                        ...
                        <div>
                            <label htmlFor="is_parent" className="block text-sm font-medium text-gray-700">
                                Is Module
                            </label>
                            <select
                                id="is_parent"
                                {...register("is_parent", { required: "is Parent is required" })}
                                className="block w-full rounded-md border border-gray-300 px-2 py-2 text-sm shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50"
                            >
                                <option value="">-- Select Is Parent  --</option>
                                <option value="0">0</option>
                                <option value="1">1</option>
                        ...
                        <div>
                            ...
                            <select
                                id="sort_order"
                                {...register("sort_order", { required: "is Parent is required" })}
                                className="block w-full rounded-md border border-gray-300 px-2 py-2 text-sm shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50"
                            >
                                <option value="">-- Select Is Parent  --</option>
                                <option value="0">0</option>
