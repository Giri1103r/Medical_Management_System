...
function App() {
  ...
  <Route path="/leftmenu/edit/:id" element={<LeftmenuEdit />} />
  ...
  {/* Location (if different component, fix later) */}
  <Route path="/location" element={<SpecializationList />} />
  <Route path="/location/add" element={<SpecializationAdd />} />
  <Route path="/location/edit/:id" element={<SpecializationEdit />} />
  <Route path="/location/view/:id" element={<SpecializationView />} />
</Routes>
