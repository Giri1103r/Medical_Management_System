          ...
          <FlashProvider>
            <div className="">
              <Routes>
                ...
                <Route path="/department" element={<Locationlist />} />
                <Route path="/department/add" element={<LocationAdd />} />
                <Route path="/department/edit/:id" element={<LocationEdit />} />
                <Route path="/department/view/:id" element={<LocationView />} />
