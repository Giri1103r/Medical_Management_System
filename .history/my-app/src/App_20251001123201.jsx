...
import DepartmentAdd from "./admin/master/location/add";
import Departmentlist from "./admin/master/location/list";
import DepartmentEdit from "./admin/master/location/edit";
import DepartmentView from "./admin/master/location/view";
