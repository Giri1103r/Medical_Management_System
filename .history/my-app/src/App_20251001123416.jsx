...
import DepartmentAdd from "./admin/master/department/add";
...
import HospitalAdd from "./admin/master/hospital/add";
import Hospitallist from "./admin/master/hospital/list";
          ...
          <FlashProvider>
            <div className="">
              <Routes>
                ...
                <Route path="/hospital" element={<Departmentlist />} />
                <Route path="/hospital/add" element={<DepartmentAdd />} />
                <Route path="/hospital/edit/:id" element={<DepartmentEdit />} />
                <Route path="/hospital/view/:id" element={<DepartmentView />} />
