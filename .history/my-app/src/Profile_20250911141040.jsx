                            ...
                            <div className="col-md-12">
                                ...
                                <div className="col-md-4">
                                 ...
                                 <div className="col-md-4">
                                    ...
                                    <input type="radio" id='male' name='male' /><label htmlFor="male">Male</label>
                                     <input type="radio" id='female' name='female' /><label htmlFor="male">FeMale</label>
                                    {errors.address && <p>{address.errors.message}</p>}
                                </div>
                                <div className="col-md-4">
                                    ...
                                    <textarea name="address" id="address" placeholder='Enter Your Address' className='form-control' {...register("address", {
                                        ...
                                        maxLength: {
                                            value: 100,
                                            message: "Maximum charater should not exceeds 100"
                                        }
                                    })}></textarea>
                                    {errors.address && <p>{address.errors.message}</p>}
                                </div>
