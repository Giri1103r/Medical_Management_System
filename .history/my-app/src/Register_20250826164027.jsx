...
const Register = () => {
    ...
    const onSubmit = async (data) => {
        try{
await axios.post('https//localhost:5000' api/register)
        }catch(err){
            return JSON()
        }
        ...
        <div>
            <form onSubmit={handleSubmit(onSubmit)}>
                <div className='col-md-12 mb-2'>
                    ...
                    <input type="text" className='form-control' name='name' id='name' placeholder='Enter the Name' {...register("name", { required: "Name is Required",
                ...
                <div className='col-md-12 mb-2'>
                    ...
                    <input type="password" name='password' id='password' placeholder='Enter the password' className='form-control' {...register("password", { required: "Password is required",
